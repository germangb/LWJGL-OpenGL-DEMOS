...
/**
 * 
 * Same as Cube, but this time, with the help of a frame buffer and a shader, the image
 * gets a blur filter. The effect uses a ping-pong multipass technique.
 * First, a vertical blur is applied, then a horizontal one.
 * 
 * @author germangb
 *
 */
public class Blur implements OpenGLEffect {
